...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/03/27 13:59:11 by dcojan            #+#    #+#             */
/*   Updated: 2014/03/27 14:12:24 by grebett          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				*tilde(char *newpwd)
{
	...
	while (newpwd[i] && newpwd[i] != '~')
		i++;
	home = get_path("HOME");
	return (ft_strjoin(home, newpwd + i + 1));
}
