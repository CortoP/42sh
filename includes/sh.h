...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/03/27 14:01:40 by grebett           #+#    #+#             */
/*   Updated: 2014/03/27 14:01:40 by grebett          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define TREE_PARAM (t_sh *, t_node *, t_node *, t_node *)
# define TREE_SIZE 6
...
# define ERR_MSG "Error : term type database not accessible or not defined."
...
void					ft_dlst_cmd_addtopos(t_cmd *c, t_dlst_cmd *n, int p);
...
void					ft_dlst_histo_addtopos(t_sh *s, t_dlst_histo *n, int p);
...
void					printprompt2(t_usent **us);
void					printprompt3(t_usent **us);

/*
**	ft_env_annexe_sh.c
*/

char					*ft_getenv(const char *ipouet);
...
int						ft_semicolon(t_sh *s, t_node *c, t_node *l, t_node *r);
int						ft_seminode(t_sh *sh, t_node *node);
int						ft_pipe(t_sh *s, t_node *c, t_node *l, t_node *r);
int						ft_chevron(t_sh *s, t_node *c, t_node *l, t_node *r);
int						ft_cmd(t_sh *s, t_node *c, t_node *l, t_node *r);

int						ft_and(t_sh *sh, t_node *cur, t_node *l, t_node *r);
int						ft_or(t_sh *sh, t_node *cur, t_node *left, t_node *r);
